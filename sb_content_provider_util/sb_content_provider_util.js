...
createContent = function(data, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('CREATE_CONTENT_URI');
...
searchContent = function(data, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('SEARCH_CONTENT_URI');
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
};
...
compositeSearch = function(data, headers, cb) {
  var url =
    configUtil.getConfig('SEARCH_SERVICE_BASE_URL') +
    configUtil.getConfig('SEARCH_URI');
  var options = getHttpOptions(
    ...
    false,
    headers,
    configUtil.getConfig('SEARCH_SERVICE_AUTHORIZATION_TOKEN')
  );
  sendRequest(options, cb);
};
...
updateContent = function(data, content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('UPDATE_CONTENT_URI') +
    '/' +
    content_id;
...
getContent = function(content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('GET_CONTENT_URI') +
    '/' +
    content_id;
...
reviewContent = function(data, content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('REVIEW_CONTENT_URI') +
    '/' +
    content_id;
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
...
publishContent = function(data, content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('PUBLISH_CONTENT_URI') +
    '/' +
    content_id;
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
...
listContent = function(data, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('LIST_CONTENT_URI');
...
retireContent = function(content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('RETIRE_CONTENT_URI') +
    '/' +
    content_id;
...
uploadContent = function(formData, content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('UPLOAD_CONTENT_URI') +
    '/' +
    content_id;
...
contentHierarchy = function(content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('HIERARCHY_CONTENT_URI') +
    '/' +
    content_id;
  var options = getHttpOptions(url, null, 'GET', false, headers);
  sendRequest(options, cb);
...
uploadMedia = function(formData, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('UPLOAD_MEDIA_URI');
  var options = getHttpOptions(url, null, 'POST', formData, headers);
  sendRequest(options, cb);
};
...
getDomains = function(headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('GET_DOMAIN_URI');
  var options = getHttpOptions(url, null, 'GET', false, headers);
  sendRequest(options, cb);
};
...
getConceptById = function(conceptId, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('GET_CONCEPT_URI') +
    '/' +
    conceptId;
  var options = getHttpOptions(url, null, 'GET', false, headers);
  sendRequest(options, cb);
...
rejectContent = function(data, content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('REJECT_CONTENT_URI') +
    '/' +
    content_id;
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
...
listTerms = function(headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('LIST_TERMS_URI');
  var options = getHttpOptions(url, null, 'GET', false, headers);
  sendRequest(options, cb);
};
...
listResourceBundles = function(headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('LIST_RESOURCE_BUNDLES_URI');
  var options = getHttpOptions(url, null, 'GET', false, headers);
  sendRequest(options, cb);
};
...
listOrdinals = function(headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('LIST_ORDINALS_URI');
  var options = getHttpOptions(url, null, 'GET', false, headers);
  sendRequest(options, cb);
};
...
flagContent = function(data, contentId, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('FLAG_CONTENT_URI') +
    '/' +
    contentId;
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
...
uploadContentUrl = function(data, content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('CONTENT_UPLOAD_URL_URI') +
    '/' +
    content_id;
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
...
sendEmail = function(data, headers, cb) {
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') +
    configUtil.getConfig('LS_SEND_EMAIL');
...
getChannel = function(defaultTenent, cb) {
  ...
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') + '/v1/org/search';
...
ekStepHealthCheck = function(cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('HEALTH_CHECK');
...
learnerServiceHealthCheck = function(cb) {
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') +
    configUtil.getConfig('LS_HEALTH_CHECK');
...
generateDialCode = function(data, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('GENERATE_DIALCODE_URI');
  var options = getHttpOptions(
    url,
    data,
    'POST',
    false,
    headers,
    configUtil.getConfig('DIAL_REPO_AUTHORIZATION_TOKEN')
  );
  sendRequest(options, cb);
};
...
getDialCode = function(dialCode_id, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('GET_DIALCODE_URI') +
    '/' +
    dialCode_id;
  var options = getHttpOptions(
    url,
...
updateDialCode = function(data, dialCode_id, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('UPDATE_DIALCODE_URI') +
    '/' +
    dialCode_id;
  var options = getHttpOptions(
    url,
...
dialCodeList = function(data, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('LIST_DIALCODE_URI');
  var options = getHttpOptions(
    url,
    data,
    'POST',
...
contentLinkDialCode = function(data, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('CONTENT_LINK_DIALCODE_URI');
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
};
...
searchDialCode = function(data, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('SEARCH_DIALCODE_URI');
  var options = getHttpOptions(
    url,
    data,
    'POST',
...
publishDialCode = function(data, dialCode_id, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('PUBLISH_DIALCODE_URI') +
    '/' +
    dialCode_id;
  var options = getHttpOptions(
    url,
...
createPublisher = function(data, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('CREATE_PUBLISHER_URI');
  var options = getHttpOptions(
    url,
    data,
    'POST',
...
getPublisher = function(publisher_id, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('GET_PUBLISHER_URI') +
    '/' +
    publisher_id;
  var options = getHttpOptions(
    url,
...
updatePublisher = function(data, publisher_id, headers, cb) {
  var url =
    configUtil.getConfig('DIAL_REPO_BASE_URL') +
    configUtil.getConfig('UPDATE_PUBLISHER_URI') +
    '/' +
    publisher_id;
  var options = getHttpOptions(
    url,
...
contentHierarchyUpdate = function(data, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('CONTENT_HIERARCHY_UPDATE_URI') +
    '/';
  var options = getHttpOptions(url, data, 'PATCH', false, headers);
  sendRequest(options, cb);
};
...
submitDataSetRequest = function(data, headers, cb) {
  var url =
    configUtil.getConfig('DATA_SERVICE_BASE_URL') +
    configUtil.getConfig('SUBMIT_DATA_EXHAUST_URI');
  var options = getHttpOptions(
    url,
    data,
    'POST',
    false,
    headers,
    configUtil.getConfig('DATA_SERVICE_AUTHORIZATION_TOKEN')
  );
  sendRequest(options, cb);
};
...
getListOfDataSetRequest = function(query, clientKey, headers, cb) {
  var url =
    configUtil.getConfig('DATA_SERVICE_BASE_URL') +
    configUtil.getConfig('LIST_DATA_EXHAUST_URI') +
    '/' +
    clientKey;
  var options = getHttpOptions(
    url,
...
getDataSetDetailRequest = function(clientKey, requestId, headers, cb) {
  var url =
    configUtil.getConfig('DATA_SERVICE_BASE_URL') +
    configUtil.getConfig('READ_DATA_EXHAUST_URI') +
    '/' +
    clientKey +
    '/' +
    requestId;
...
getChannelDataSetRequest = function(query, dataSetId, channel, headers, cb) {
  var url =
    configUtil.getConfig('DATA_SERVICE_BASE_URL') +
    configUtil.getConfig('CHANNEL_DATA_EXHAUST_URI') +
    '/' +
    dataSetId +
    '/' +
    channel;
...
systemUpdateContent = function(data, contentId, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('SYSTEM_UPDATE_CONTENT_URI') +
    '/' +
    contentId;
  var options = getHttpOptions(url, data, 'PATCH', false, headers);
  sendRequest(options, cb);
...
learnerServiceGetForm = function(data, headers, cb) {
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') +
    configUtil.getConfig('LS_FORM_READ');
  var options = getHttpOptionsForLS(url, data, 'POST', false, headers);
  sendRequest(options, cb);
};
...
learnerServiceCreateForm = function(data, headers, cb) {
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') +
    configUtil.getConfig('LS_FORM_CREATE');
  var options = getHttpOptionsForLS(url, data, 'POST', false, headers);
  sendRequest(options, cb);
};
...
learnerServiceUpdateForm = function(data, headers, cb) {
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') +
    configUtil.getConfig('LS_FORM_UPDATE');
  var options = getHttpOptionsForLS(url, data, 'POST', false, headers);
  sendRequest(options, cb);
};
...
copyContent = function(data, content_id, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('COPY_CONTENT_URI') +
    '/' +
    content_id;
  var options = getHttpOptions(url, data, 'POST', false, headers);
  sendRequest(options, cb);
...
getAllRootOrgs = function(data, cb) {
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') +
    configUtil.getConfig('LS_ORG_SEARCH');
...
pluginsSearch = function(data, headers, cb) {
  var url =
    configUtil.getConfig('PLUGIN_REPO_BASE_URL') +
    configUtil.getConfig('PLUGINS_SEARCH_URI');
  var options = getHttpOptions(
    url,
    data,
    'POST',
    false,
    headers,
    configUtil.getConfig('PLUGIN_REPO_AUTHORIZATION_TOKEN')
  );
  sendRequest(options, cb);
};
...
getForm = function(data, headers, cb) {
  var url =
    configUtil.getConfig('SUNBIRD_PORTAL_BASE_URL') +
    configUtil.getConfig('FORM_READ');
  var options = getHttpOptionsForLS(url, data, 'POST', false, headers);
  sendRequest(options, cb);
};
...
userSearch = function(data, headers, cb) {
  var url =
    configUtil.getConfig('LEARNER_SERVICE_LOCAL_BASE_URL') + '/v1/user/search';
  var options = getHttpOptionsForLS(url, data, 'POST', false, headers);
  sendRequest(options, cb);
};
...
releaseDialcode = function(contentId, data, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('RELEASE_DIALCODE') +
    '/' +
    contentId;
  var options = getHttpOptions(url, data, 'PATCH', false, headers);
  postRequest(options, cb);
...
reserveDialcode = function(contentId, data, headers, cb) {
  var url =
    configUtil.getConfig('CONTENT_REPO_BASE_URL') +
    configUtil.getConfig('RESERVE_DIALCODE') +
    '/' +
    contentId;
  var options = getHttpOptions(url, data, 'POST', false, headers);
  postRequest(options, cb);
...
nlpContentSearch = function(querystring, headers, cb) {
  var url =
    configUtil.getConfig('NLP_SEARCH_BASE_URL') +
    configUtil.getConfig('NLP_SEARCH_URI');
...
function generateApiCallLogEvent(http_options) {
  ...
  const edata = telemetry.logEventData(
    'INFO',
    level,
    message,
  ...
  telemetry.log({
    ...
    context:
      ...
      telemetry.getContextData(telemetryData.context),
